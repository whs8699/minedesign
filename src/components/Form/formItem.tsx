...
export const FormItem: FC<FormItemProps> = (props) => {
  ...
  const rowClass = classNames('mc-row', {
    'mc-row-no-label': !label
  })
  useEffect(() => {
  ...
  const labelClass = classNames({
    'mc-form-item-required': isRequired
  })
  const itemClass = classNames('mc-form-item-control', {
    'mc-form-item-has-error': hasError
  })
  ...
  return (
    <div className={rowClass}>
      { label &&
        <div className='mc-form-item-label'>
          <label title={label} className={labelClass}>
            {label}
          </label>
        </div>
      }
      <div className='mc-form-item'>
        <div className={itemClass}>
          {returnChildNode}
        </div>
        { hasError && 
          <div className='mc-form-item-explain'>
